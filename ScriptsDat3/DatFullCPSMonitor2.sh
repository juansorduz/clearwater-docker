...
. ~/clearwater-docker/ScriptsDat3/DatMonitor1.sh  25 $Duration $password $option $NumberTest
. ~/clearwater-docker/ScriptsDat3/DatMonitor1.sh  50 $Duration $password $option $NumberTest
. ~/clearwater-docker/ScriptsDat3/DatMonitor1.sh  75 $Duration $password $option $NumberTest
. ~/clearwater-docker/ScriptsDat3/DatMonitor1.sh  100 $Duration $password $option $NumberTest
. ~/clearwater-docker/ScriptsDat3/DatMonitor1.sh  125 $Duration $password $option $NumberTest
. ~/clearwater-docker/ScriptsDat3/DatMonitor1.sh  150 $Duration $password $option $NumberTest
. ~/clearwater-docker/ScriptsDat3/DatMonitor1.sh  175 $Duration $password $option $NumberTest
