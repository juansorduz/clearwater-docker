...
set xlabel "CPS"
set ylabel "SCR"
plot "~/ClearwaterTestResults/Summaries/b1urs1mscs1urh1msch1/SUMMARYSCR2" using 2:xtic(1) title 'Combinación 1' w l lc 1, \
     "~/ClearwaterTestResults/Summaries/b1urs1mscs1urh1msch1/SUMMARYSCR2" using 2:xtic(1) with points notitle pt 2 ps 0.5 lc 1, \
     "~/ClearwaterTestResults/Summaries/b2urs1mscs1urh1msch1/SUMMARYSCR2" using 2:xtic(1) title 'Combinación 2' w l lc 2, \
     "~/ClearwaterTestResults/Summaries/b2urs1mscs1urh1msch1/SUMMARYSCR2" using 2:xtic(1) with points notitle pt 2 ps 0.5 lc 2, \
     "~/ClearwaterTestResults/Summaries/b1urs2mscs1urh1msch1/SUMMARYSCR2" using 2:xtic(1) title 'Combinación 3' w l lc 3, \
     "~/ClearwaterTestResults/Summaries/b1urs2mscs1urh1msch1/SUMMARYSCR2" using 2:xtic(1) with points notitle pt 2 ps 0.5 lc 3, \
     "~/ClearwaterTestResults/Summaries/b1urs1mscs2urh1msch1/SUMMARYSCR2" using 2:xtic(1) title 'Combinación 4' w l lc 4, \
     "~/ClearwaterTestResults/Summaries/b1urs1mscs2urh1msch1/SUMMARYSCR2" using 2:xtic(1) with points notitle pt 2 ps 0.5 lc 4, \
     "~/ClearwaterTestResults/Summaries/b3urs1mscs1urh1msch1/SUMMARYSCR2" using 2:xtic(1) title 'Combinación 5' w l lc 5, \
     "~/ClearwaterTestResults/Summaries/b3urs1mscs1urh1msch1/SUMMARYSCR2" using 2:xtic(1) with points notitle pt 2 ps 0.5 lc 5, \
     "~/ClearwaterTestResults/Summaries/b2urs2mscs1urh1msch1/SUMMARYSCR2" using 2:xtic(1) title 'Combinación 6' w l lc 6, \
     "~/ClearwaterTestResults/Summaries/b2urs2mscs1urh1msch1/SUMMARYSCR2" using 2:xtic(1) with points notitle pt 2 ps 0.5 lc 6, \
     "~/ClearwaterTestResults/Summaries/b2urs1mscs2urh1msch1/SUMMARYSCR2" using 2:xtic(1) title 'Combinación 7' w l lc 7, \
