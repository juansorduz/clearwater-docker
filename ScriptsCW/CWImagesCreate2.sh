...
for i in base2 astaire2 urcassandra msccassandra urchronos mscchronos bono2 ellis2 homer2 urhomestead mschomestead homestead-prov2 ralf2 ursprout mscsprout sipptest; do docker build -t clearwater/$i $i ; done
