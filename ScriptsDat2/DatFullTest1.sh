...
echo -e "NumSipp=1\nNumBono=1\nNumURS=1\nNumMSCS=1\nNumURH=1\nNumMSCH=1\nMaintestfolder=~/ClearwaterTestResults/Kubernetes5" > ~/clearwater-docker/ScriptsDat2/TrafficGenerator/TestCharacteristics
. ~/clearwater-docker/ScriptsDat2/DatFullCPSMonitor1.sh 60 $password 2 2
. ~/clearwater-docker/ScriptsDat2/DatFullCPSSummary1.sh 60 2
. ~/clearwater-docker/ScriptsDat2/DatFullCPSPromedy1.sh 60 2
. ~/clearwater-docker/ScriptsDat2/DatFullLatency1.sh 2
