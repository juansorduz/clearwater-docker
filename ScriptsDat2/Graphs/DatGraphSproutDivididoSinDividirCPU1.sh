...
set terminal pdf
set output "DespliegueCPSvsCPUSproutDivididoSinDividir.pdf"
set xlabel "CPS"
...
plot "~/ClearwaterTestResultsSproutDividido/Summaries/b1urs1mscs1urh1msch1/SUMMARYVMCPU" using 18:19:xtic(1) title 'Sprout Dividido' lc 1, \
     "~/ClearwaterTestResultsSproutSinDividir/Summaries/b2urs1mscs1urh1msch1/SUMMARYVMCPU" using 18:19:xtic(1) title 'Sprout sin dividir' lc 2
EOF
