...
docker run -d --net=clearwater_nw --name URcassandra -p 22 --sysctl net.ipv6.conf.lo.disable_ipv6=0 clearwater/cassandra
docker run -d --net=clearwater_nw --name MSCcassandra -p 22 --sysctl net.ipv6.conf.lo.disable_ipv6=0 clearwater/cassandra
...
docker run -d --net=clearwater_nw --name URhomestead -p 22 clearwater/homestead
docker run -d --net=clearwater_nw --name MSChomestead -p 22 clearwater/homestead
...
docker run -d --net=clearwater_nw --network-alias=sprout --network-alias=scscf.sprout --name scscf.sprout -p 22 clearwater/sprout-full
docker run -d --net=clearwater_nw --network-alias=icscf.sprout --name icscf.sprout -p 22 clearwater/sprout-full
