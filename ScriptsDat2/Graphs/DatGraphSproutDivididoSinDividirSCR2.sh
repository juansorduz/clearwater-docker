...
plot "~/ClearwaterTestResultsSproutDividido/Summaries/b1urs1mscs1urh1msch1/SUMMARYSCR2" using 2:xtic(1) title 'Sprout Dividido' w l lc 1, \
     ...
     "~/ClearwaterTestResultsSproutSinDividir/Summaries/b2urs1mscs1urh1msch1/SUMMARYSCR2" using 2:xtic(1) title 'Sprout no Dividido' w l lc 2, \
     "~/ClearwaterTestResultsSproutSinDividir/Summaries/b2urs1mscs1urh1msch1/SUMMARYSCR2" using 2:xtic(1) with points notitle pt 2 ps 0.5 lc 2
EOF
