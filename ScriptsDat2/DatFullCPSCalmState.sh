...
echo Starting tests
#. ~/clearwater-docker/ScriptsDat2/DatMonitorCalmState.sh 10 $duration $password $optionMonitor $NumberTest
. ~/clearwater-docker/ScriptsDat2/DatMonitorCalmState.sh 25 $duration $password $optionMonitor $NumberTest
#. ~/clearwater-docker/ScriptsDat2/DatMonitorCalmState.sh 30 $duration $password $optionMonitor $NumberTest
. ~/clearwater-docker/ScriptsDat2/DatMonitorCalmState.sh 50 $duration $password $optionMonitor $NumberTest
#. ~/clearwater-docker/ScriptsDat2/DatMonitorCalmState.sh 50 $duration $password $optionMonitor $NumberTest
. ~/clearwater-docker/ScriptsDat2/DatMonitorCalmState.sh 75 $duration $password $optionMonitor $NumberTest
#. ~/clearwater-docker/ScriptsDat2/DatMonitorCalmState.sh 70 $duration $password $optionMonitor $NumberTest
#. ~/clearwater-docker/ScriptsDat2/DatMonitorCalmState.sh 80 $duration $password $optionMonitor $NumberTest
#. ~/clearwater-docker/ScriptsDat2/DatMonitorCalmState.sh 90 $duration $password $optionMonitor $NumberTest
. ~/clearwater-docker/ScriptsDat2/DatMonitorCalmState.sh 100 $duration $password $optionMonitor $NumberTest
. ~/clearwater-docker/ScriptsDat2/DatMonitorCalmState.sh 125 $duration $password $optionMonitor $NumberTest
. ~/clearwater-docker/ScriptsDat2/DatMonitorCalmState.sh 150 $duration $password $optionMonitor $NumberTest
. ~/clearwater-docker/ScriptsDat2/DatMonitorCalmState.sh 175 $duration $password $optionMonitor $NumberTest
. ~/clearwater-docker/ScriptsDat2/DatMonitorCalmState.sh 200 $duration $password $optionMonitor $NumberTest
# exit 0
# . ~/clearwater-docker/ScriptsDat2/DatMonitorCalmState.sh 225 $duration $password $optionMonitor $NumberTest
# . ~/clearwater-docker/ScriptsDat2/DatMonitorCalmState.sh 250 $duration $password $optionMonitor $NumberTest
# . ~/clearwater-docker/ScriptsDat2/DatMonitorCalmState.sh 275 $duration $password $optionMonitor $NumberTest
# . ~/clearwater-docker/ScriptsDat2/DatMonitorCalmState.sh 300 $duration $password $optionMonitor $NumberTest
#
# . ~/clearwater-docker/ScriptsDat2/DatMonitorCalmState.sh 10 $duration $password $optionMonitor $NumberTest
# #. ~/clearwater-docker/ScriptsDat2/DatMonitorCalmState.sh 20 $duration $password $optionMonitor $NumberTest
# . ~/clearwater-docker/ScriptsDat2/DatMonitorCalmState.sh 30 $duration $password $optionMonitor $NumberTest
# #. ~/clearwater-docker/ScriptsDat2/DatMonitorCalmState.sh 40 $duration $password $optionMonitor $NumberTest
# ·. ~/clearwater-docker/ScriptsDat2/DatMonitorCalmState.sh 50 $duration $password $optionMonitor $NumberTest
# . ~/clearwater-docker/ScriptsDat2/DatMonitorCalmState.sh 60 $duration $password $optionMonitor $NumberTest
# . ~/clearwater-docker/ScriptsDat2/DatMonitorCalmState.sh 70 $duration $password $optionMonitor $NumberTest
# . ~/clearwater-docker/ScriptsDat2/DatMonitorCalmState.sh 80 $duration $password $optionMonitor $NumberTest
# . ~/clearwater-docker/ScriptsDat2/DatMonitorCalmState.sh 90 $duration $password $optionMonitor $NumberTest
# . ~/clearwater-docker/ScriptsDat2/DatMonitorCalmState.sh 100 $duration $password $optionMonitor $NumberTest
# . ~/clearwater-docker/ScriptsDat2/DatMonitorCalmState.sh 120 $duration $password $optionMonitor $NumberTest
# . ~/clearwater-docker/ScriptsDat2/DatMonitorCalmState.sh 150 $duration $password $optionMonitor $NumberTest
# . ~/clearwater-docker/ScriptsDat2/DatMonitorCalmState.sh 180 $duration $password $optionMonitor $NumberTest
# #. ~/clearwater-docker/ScriptsDat2/DatMonitorCalmState.sh 210 $duration $password $optionMonitor $NumberTest
# . ~/clearwater-docker/ScriptsDat2/DatMonitorCalmState.sh 240 $duration $password $optionMonitor $NumberTest
# #. ~/clearwater-docker/ScriptsDat2/DatMonitorCalmState.sh 270 $duration $password $optionMonitor $NumberTest
# #. ~/clearwater-docker/ScriptsDat2/DatMonitorCalmState.sh 200 $duration $password $optionMonitor $NumberTest
# #. ~/clearwater-docker/ScriptsDat2/DatMonitorCalmState.sh 250 $duration $password $optionMonitor $NumberTest
# . ~/clearwater-docker/ScriptsDat2/DatMonitorCalmState.sh 300 $duration $password $option $NumberTest
#exit 0
