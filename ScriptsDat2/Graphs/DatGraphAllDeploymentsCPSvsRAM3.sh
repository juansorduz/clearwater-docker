...
plot "~/ClearwaterTestResults/Summaries/b1urs1mscs1urh1msch1/SUMMARYVMRAM" using 18:19:xtic(1) title '111' lc 1, \
     "~/ClearwaterTestResults/Summaries/b2urs1mscs1urh1msch1/SUMMARYVMRAM" using 18:19:xtic(1) title '211' lc 4, \
     "~/ClearwaterTestResults/Summaries/b2urs2mscs1urh1msch1/SUMMARYVMRAM" using 18:19:xtic(1) title '221' lc 2, \
     "~/ClearwaterTestResults/Summaries/b2urs1mscs2urh1msch1/SUMMARYVMRAM" using 18:19:xtic(1) title '212' lc 3, \
     "~/ClearwaterTestResults/Summaries/b3urs2mscs1urh1msch1/SUMMARYVMRAM" using 18:19:xtic(1) title '321' lc 5, \
     "~/ClearwaterTestResults/Summaries/b3urs1mscs2urh1msch1/SUMMARYVMRAM" using 18:19:xtic(1) title '312' lc 6, \
     "~/ClearwaterTestResults/Summaries/b3urs2mscs2urh1msch1/SUMMARYVMRAM" using 18:19:xtic(1) title '322' lc 7, \
