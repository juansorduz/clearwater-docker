...
plot "~/ClearwaterTestResults/Summaries/b1urs1mscs1urh1msch1/SUMMARYVMRAM" using 18:19:xtic(1) title 'Combinación 1' lc 1, \
     "~/ClearwaterTestResults/Summaries/b2urs1mscs1urh1msch1/SUMMARYVMRAM" using 18:19:xtic(1) title 'Combinación 2' lc 2, \
     "~/ClearwaterTestResults/Summaries/b1urs2mscs1urh1msch1/SUMMARYVMRAM" using 18:19:xtic(1) title 'Combinación 3' lc 3, \
     "~/ClearwaterTestResults/Summaries/b1urs1mscs2urh1msch1/SUMMARYVMRAM" using 18:19:xtic(1) title 'Combinación 4' lc 4, \
     "~/ClearwaterTestResults/Summaries/b3urs1mscs1urh1msch1/SUMMARYVMRAM" using 18:19:xtic(1) title 'Combinación 5' lc 5, \
     "~/ClearwaterTestResults/Summaries/b2urs2mscs1urh1msch1/SUMMARYVMRAM" using 18:19:xtic(1) title 'Combinación 6' lc 6, \
     "~/ClearwaterTestResults/Summaries/b2urs1mscs2urh1msch1/SUMMARYVMRAM" using 18:19:xtic(1) title 'Combinación 7' lc 7, \
