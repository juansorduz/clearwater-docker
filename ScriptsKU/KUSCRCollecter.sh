...
./ScriptsKU/KUMonitor_independent.sh 45 30 10.244.6.15 2 sipptest-8548ccd744-6njbp &
./ScriptsKU/KUMonitor_independent.sh 50 30 10.244.4.29 2 sipptest-8548ccd744-d5zll &
./ScriptsKU/KUMonitor_independent.sh 35 30 10.244.2.29 2 sipptest-8548ccd744-hz984 &
./ScriptsKU/KUMonitor_independent.sh 40 30 10.244.5.8 2 sipptest-8548ccd744-j6l5k &
./ScriptsKU/KUMonitor_independent.sh 30 30 10.244.3.30 2 sipptest-8548ccd744-m75v4 &
sum=0
sleep 5
...
while [ "$sum" -lt '10' ]; do
  echo hola
  sum=0
  source $testfolder/4530/1/Variables.txt
...
for j in 4530 5030 3530 4030 3030 ; do
...
mkdir ~/ClearwaterTestResults/200/$j
echo $SuccesfullCallRate >> ~/ClearwaterTestResults/200/$j/PromediosSCPS$i
