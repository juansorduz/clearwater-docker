...
sed -i '1i s_p_r_o_u_t_3          s_p_r_o_u_t_3           s_p_r_o_u_t_3' $testfolder/s_p_r_o_u_t_3.csv
...
for FILE in astaire cassandra chronos bono homer homestead ralf s_p_r_o_u_t_3 sprout sipptest ; do
    gnuplot <<- EOF
