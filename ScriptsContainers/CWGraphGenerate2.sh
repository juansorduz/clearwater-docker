...
#for FILE in astaire cassandra chronos bono ellis homer homestead homestead-prov ralf scscf.sprout icscf.sprout sipptest ; do
for FILE in astaire cassandra chronos bono homer homestead ralf scscf.sprout icscf.sprout sipptest ; do
    gnuplot <<- EOF
