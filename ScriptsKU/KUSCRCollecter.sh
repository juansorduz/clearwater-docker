...
./ScriptsKU/KUMonitor_independent.sh 55 30 10.244.6.15 2 sipptest-8548ccd744-6njbp &
./ScriptsKU/KUMonitor_independent.sh 60 30 10.244.4.29 2 sipptest-8548ccd744-d5zll &
./ScriptsKU/KUMonitor_independent.sh 45 30 10.244.2.29 2 sipptest-8548ccd744-hz984 &
./ScriptsKU/KUMonitor_independent.sh 50 30 10.244.5.8 2 sipptest-8548ccd744-j6l5k &
./ScriptsKU/KUMonitor_independent.sh 40 30 10.244.3.30 2 sipptest-8548ccd744-m75v4 &
sum=0
sleep 5
mkdir ~/ClearwaterTestResults/250
while [ "$sum" -lt '10' ]; do
  echo hola
  sum=0
...
for j in 5530 6030 4530 5030 4030 ; do
