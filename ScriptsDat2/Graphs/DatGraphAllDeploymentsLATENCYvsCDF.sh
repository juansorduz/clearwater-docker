...
set terminal pdf
set output "LATENCYCDFComb5.pdf"
set xlabel "Latency (ms)"
set ylabel "SCR (%)"
plot "~/ClearwaterTestResults2/Summaries/b3urs1mscs1urh1msch1/SUMMARYLATENCYCDF" using 1:(${NumFilesCombination5}) smooth cumul title "Combination5" lc 7
EOF
