...
set terminal pdf
set output "${nivel}DespliegueVMCPSvsRAM.pdf"
set xlabel "CPS"
...
plot "~/ClearwaterTestResults/Summaries/b1urs1mscs1urh1msch1/SUMMARYVMRAM" using 18:19:xtic(1) title 'Combination 1' lc 1, \
     ...
     "~/ClearwaterTestResults/Summaries/b3urs1mscs1urh1msch1/SUMMARYVMRAM" using 18:19:xtic(1) title 'Combination 3' lc 6, \
     "~/ClearwaterTestResults/Summaries/b3urs2mscs1urh1msch1/SUMMARYVMRAM" using 18:19:xtic(1) title 'Combination 4' lc 7, \
     "~/ClearwaterTestResults/Summaries/b3urs1mscs2urh1msch1/SUMMARYVMRAM" using 18:19:xtic(1) title 'Combination 5' lc 5, \
     "~/ClearwaterTestResults/Summaries/VM/SUMMARYVMRAM" using 18:19:xtic(1) title 'Regular vIMS' lc 8
EOF
