...
docker exec sipptest /usr/share/clearwater/bin/run_stress2 example.com $users $duration > ~/ClearwaterTestResults/Containers2/$users$duration/$users$duration$NumTest/logsTestContainer.txt
