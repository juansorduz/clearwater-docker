...
. ~/clearwater-docker/ScriptsDat3/DatMonitor1.sh  225 $Duration $password $option $NumberTest
. ~/clearwater-docker/ScriptsDat3/DatMonitor1.sh  250 $Duration $password $option $NumberTest
. ~/clearwater-docker/ScriptsDat3/DatMonitor1.sh  275 $Duration $password $option $NumberTest
