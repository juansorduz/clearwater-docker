...
for FILE in astaire urcassandra msccassandra chronos homestead-prov ellis bono homer urhomestead mschomestead ralf ursprout mscsprout sipptest; do
    gnuplot <<- EOF
