...
./ScriptsKU/KUMonitor_independent.sh 100 30 10.244.4.14 2 sipptest-8548ccd744-pzw72 &
./ScriptsKU/KUMonitor_independent.sh 40 30 10.244.3.14 2 sipptest-8548ccd744-8ctdr &
./ScriptsKU/KUMonitor_independent.sh 30 30 10.244.1.17 2 sipptest-8548ccd744-mmpqs &
./ScriptsKU/KUMonitor_independent.sh 10 30 10.244.2.15 2 sipptest-8548ccd744-hnxhf &
...
while [ "$sum" -lt '10' ]; do
  echo hola
  sum=0
  source $testfolder/10030/1/Variables.txt
...
for j in 10030 4030 3030 1030 2030 ; do
