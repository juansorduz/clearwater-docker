...
#docker run -d --net=clearwater_nw --name mscchronos -p 22 clearwater/chronos2
...
sleep 120
docker exec urcassandra /usr/share/clearwater/crest-prov/src/metaswitch/crest/tools/stress_provision.sh 30000
