...
[ -e $testMainfolder/CLEANSUMMARYVMCPU ] && rm $testMainfolder/CLEANSUMMARYVMCPU
[ -e $testMainfolder/CLEANSUMMARYVMRAM ] && rm $testMainfolder/CLEANSUMMARYVMRAM

while IFS=" " read -r LocalSCR remainder
do
  echo  remainder
