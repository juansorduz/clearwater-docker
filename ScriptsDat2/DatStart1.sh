...
sshpass -p $password scp -r -o StrictHostKeyChecking=no ~/clearwater-docker/ScriptsDat/LocalFiles/DataTest.txt master@$AddressVM0:~/
...
sshpass -p $password scp -r -o StrictHostKeyChecking=no ~/clearwater-docker/ScriptsDat/LocalFiles/ControlLocalDockerMonitor.sh master@$AddressVM0:~/
...
sshpass -p $password scp -r -o StrictHostKeyChecking=no ~/clearwater-docker/ScriptsDat/LocalFiles/LocalDockerMonitor1.sh master@$AddressVM0:~/
...
sshpass -p $password scp -r -o StrictHostKeyChecking=no ~/clearwater-docker/ScriptsDat/LocalFiles/LocalDockerMonitor2.sh master@$AddressVM0:~/
...
sshpass -p $password scp -r -o StrictHostKeyChecking=no ~/clearwater-docker/ScriptsDat/LocalFiles/LocalDockerMonitor3.sh master@$AddressVM0:~/
