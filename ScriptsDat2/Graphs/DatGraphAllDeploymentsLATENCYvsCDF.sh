...
set terminal pdf
set output "LATENCYCDFComb4.pdf"
set xlabel "Latency (ms)"
set ylabel "SCR (%)"
plot "~/ClearwaterTestResults2/Summaries/b2urs1mscs1urh1msch1/SUMMARYLATENCYCDF" using 1:(${NumFilesCombination4}) smooth cumul title "Combination4" lc 4
EOF
