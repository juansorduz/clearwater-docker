...
docker run -d --net=clearwater_nw --network-alias=icscf.sprout --name scscf.sprout -p 22 clearwater/sprout-scscf
docker run -d --net=clearwater_nw --network-alias=scscf.sprout --name icscf.sprout -p 22 clearwater/sprout-icscf
#docker run -d --net=clearwater_nw  --network-alias=scscf.sprout --name sprout -p 22 clearwater/sprout
